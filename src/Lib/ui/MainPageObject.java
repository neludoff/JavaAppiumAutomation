...
public class MainPageObject
{
    ...
    public List<WebElement> waitForElementsPresent(By by, String error_message, int tiomeoutinseconds){
        try {
            Thread.sleep(5000);
    ...
    public WebElement waitForElementPresent(By by, String error_message, int tiomeoutinseconds){
        WebDriverWait wait = new WebDriverWait(driver, tiomeoutinseconds);
        wait.withMessage(error_message + "\n");
        return wait.until(
